...
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/__init__.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/__init__.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/ConsoleMonitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/ConsoleMonitor.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/DiskMonitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/DiskMonitor.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/IOMonitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/IOMonitor.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/InputMonitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/InputMonitor.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/LoadMonitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/LoadMonitor.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/Monitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/Monitor.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/ProcessMonitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/ProcessMonitor.py"
install -Dm644 "$srcdir/powernap-$pkgver/powernap/monitors/TCPMonitor.py" "$pkgdir/usr/lib/python3.5/site-packages/powernap/monitors/TCPMonitor.py"
